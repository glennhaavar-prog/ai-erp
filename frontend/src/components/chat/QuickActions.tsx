  ...
  return (
    <div className="border-b border-gray-200 bg-white">
      ...
      <button
        ...
        className="w-full px-4 py-2 flex items-center justify-between text-sm text-gray-600 hover:bg-gray-50 transition-colors cursor-pointer"
      >
          ...
          {QUICK_ACTIONS.map((action, idx) => {
            ...
            return (
              <button
                ...
                disabled={disabled}
                className={`
                  flex items-center gap-2 px-3 py-2 rounded-lg border transition-colors text-sm font-medium cursor-pointer
