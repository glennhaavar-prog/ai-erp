/**
 * Sheet Component - Slide-in panel from right side
  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        side === 'left' &&
          'inset-y-0 left-0 h-full w-[400px] border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left',
        className
      )}
      {...props}
    >
